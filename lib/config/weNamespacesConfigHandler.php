 ...
 *
 */
class weNamespacesConfigHandler extends sfDefineEnvironmentConfigHandler
{
	/**
	...
	public function execute($configFiles)
	{
		...
		$config .=
			...
			"\$dispatcher->notify(new sfEvent(\$dispatcher, 'config.namespaces_configuration_loaded'));\n"
		;
		return $config;
	}
}
